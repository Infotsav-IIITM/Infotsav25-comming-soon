...
export default function ContactSection() {
  ...
  const contactInfo = [
    ...
    { 
      ...
      label: "Visit Us", 
      value: "University Campus, Tech City, India" 
    },
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-foreground/80 max-w-3xl mx-auto">
            Have questions about Infotsav 2025? Our team is here to help. Reach out to us through any of the channels below.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          ...
          >
            ...
            <div className="space-y-6 mb-8">
              {contactInfo.map((info, index) => (
                <div key={index} className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-sm font-medium text-foreground/70">{info.label}</h4>
            ...
            <h4 className="text-sm font-medium text-foreground/70 mb-4">Follow Us</h4>
