...
export default function SponsorsSection() {
    ...
    return (
        <section id="sponsors" className="py-20 relative" ref={ref}>
            ...
            <div className="container mx-auto px-4 relative z-10">
                <motion.div
                    ...
                    <p className="text-lg text-foreground/80 max-w-3xl mx-auto">
                        Infotsav wouldn't be possible without the generous
                        support of our sponsors. These industry leaders help us
                        bring the festival to life.
                    </p>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="mb-16">
                    <h3 className="text-lg font-semibold mb-8 text-center text-foreground/70">
                        Platinum Sponsors
                    </h3>
                    ...
                    <h3 className="text-lg font-semibold my-8 text-center text-foreground/70">
                        Gold Sponsors
                    </h3>
                    <div className="flex justify-center gap-8 flex-wrap">
                        <motion.div
                ...
                <motion.div
                    ...
                    <p className="text-foreground/70 mb-6">
                        Join our prestigious list of sponsors and connect your
                        brand with tech-savvy, creative individuals. Sponsorship
                        packages offer excellent brand visibility and networking
                        opportunities.
                    </p>
                    <Button
