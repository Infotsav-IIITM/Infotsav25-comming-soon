...
const features = [
    {
        ...
        description:
            "Compete in coding, hackathons, and algorithm challenges with participants from across the country.",
    },
    {
        icon: <Palette className="w-6 h-6 text-secondary" />,
        title: "Cultural Events",
        description:
            "Experience a fusion of technology and culture through art installations, performances, and exhibitions.",
    },
    {
        icon: <BookOpen className="w-6 h-6 text-accent" />,
        title: "Workshops",
        description:
            "Learn from industry experts in hands-on sessions covering cutting-edge technologies and creative processes.",
    },
    {
        icon: <Users className="w-6 h-6 text-neon-4" />,
        title: "Networking",
        description:
            "Connect with like-minded individuals, potential collaborators, mentors, and industry professionals.",
    },
    {
        icon: <Award className="w-6 h-6 text-primary" />,
        title: "Awards",
        description:
            "Win prestigious accolades and prizes worth across various competition categories.",
    },
    {
        icon: <Zap className="w-6 h-6 text-secondary" />,
        title: "Tech Talks",
        description:
            "Gain insights from thought leaders and visionaries shaping the future of technology and culture.",
    },
];
            ...
            <div className="container mx-auto px-4">
                <motion.div
                    ...
                    <p className="text-lg text-foreground/80 max-w-3xl mx-auto">
                        Infotsav is the annual techno-cultural festival that
                        bridges the gap between technology and artistic
                        expression. Join us for three days of innovation,
